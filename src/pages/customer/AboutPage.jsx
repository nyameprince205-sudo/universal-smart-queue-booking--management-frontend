  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-bold text-slate-800">About Universal Smart Queue Booking Management</h1>

        <section className="mt-8">
          <h2 className="text-xl font-semibold text-slate-800">Platform Overview</h2>
          <p className="mt-2 text-slate-600 leading-relaxed">
            Universal-Smart Queue Booking Management is a multi-tenant queue and booking management platform built for restaurants, salons,
