...
function ResendVerificationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // Same non-enumeration pattern as forgot-password — identical
      // response whether the account exists, is already verified, or
      // neither (see auth.controller.js's resendVerification).
      setSubmitting(false);
      setSubmitted(true);
    }
  }
